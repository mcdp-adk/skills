...
| [`project-knowledge`](project-knowledge/SKILL.md) | 任务本身是为了服务开发、创作或完成而建立或修复项目知识，将其应用于具体决策、行动或评价，或根据新的证据与学习使其演化。 | 包含约 37 MB 的 CC BY 4.0 研究论文 PDF；详见[第三方声明](project-knowledge/THIRD_PARTY_NOTICES.md)。 |
