...
description: Review artifacts against the task goal and carry findings through fixes and verification. Use when a review is requested or required, findings need follow-up, or the cumulative result needs checking before declaring reviewed work complete.
metadata:
  internal: true
---
