...
| [`eroge-hanhua`](eroge-hanhua/SKILL.md) | Creates Simplified Chinese text patches for Japanese R18 games, with an interactive workflow for scope, translation, review, and delivery. |
