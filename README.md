...
| [`eroge-hanhua`](eroge-hanhua/SKILL.md) | Localizes Japanese game text into Simplified Chinese and prepares patches, with contextual translation, terminology review, display checks, and delivery verification. |
