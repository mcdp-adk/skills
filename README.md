...
| [`project-knowledge`](project-knowledge/SKILL.md) | The task itself is to establish or repair project knowledge for development, creation, or completion; apply it to a concrete decision, action, or evaluation; or evolve it from new evidence or learning. | Includes about 37 MB of CC BY 4.0 research PDFs; see the [third-party notices](project-knowledge/THIRD_PARTY_NOTICES.md). |
