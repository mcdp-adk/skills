...
| [`eroge-hanhua-workflow`](eroge-hanhua-workflow/SKILL.md) | Produces Simplified Chinese patches for Japanese R18 games through four stages: workspace setup, end-to-end sample validation, full translation and review, and final game acceptance and delivery. |
